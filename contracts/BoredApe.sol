...
contract BoredApe is ERC721, Ownable, ReentrancyGuard, PaymentSplitter {
  ...
  uint256 _price = 10000000000000000; // 0.01 ETH or MATIC
  ...
  function presaleMint(
    ...
    require(
      ...
      "BoredApes: You can't mint so many tokens"
    );
    require(
    ...
    require(current + _amount <= maxSupply, 'BoredApes: max supply exceeded');
    require(_price * _amount <= msg.value, 'BoredApes: Not enough ethers sent');
